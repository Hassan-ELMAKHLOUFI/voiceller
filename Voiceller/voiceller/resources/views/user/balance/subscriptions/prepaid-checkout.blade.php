...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('Pre Paid Plan Checkout') }}</h4>
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12 pl-4">
								<div class="checkout-wrapper-box">
									...
									<p class="checkout-title mt-2"><i class="fa fa-archive mr-2"></i>{{ __('Plan Name') }}: <span class="text-info">{{ $id->plan_name }}  {{ __('Pre Paid Characters') }}</span></p>
